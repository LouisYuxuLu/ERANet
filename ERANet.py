...
class Main(nn.Module):
	...
	def forward(self,x):
		...
		x_1 = self.repb1(self.ecbb(x_in) + x_in)
		x_2 = self.repb2(self.ecbb(x_1) + x_1)        
		x_3 = self.repb3(self.ecbb(x_2) + x_2)
		x_4 = self.repb4(self.ecbb(x_3) + x_3)
		x_5 = self.repb5(self.ecbb(x_4) + x_4)
...
class MultiEdge(nn.Module):    #Basic Block (BB)
	def __init__(self,channel):                                
